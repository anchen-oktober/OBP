...
| `Detection Radius` | Fast `2200`, Heavy `1800` | Радиус обнаружения игрока в сантиметрах. Снаружи враг продолжает патруль при `Bullet: Ready`; внутри начинает преследование, и контактное убийство разрешено. |
